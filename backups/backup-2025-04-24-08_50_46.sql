...
(218776379056128,'2025-04-23 18:20:19.333539',NULL,NULL,199268075270145,'holaa','ADULT'),
(218776384032768,'2025-04-23 18:20:20.547429',NULL,NULL,199268075270145,'Hola! ¡Es un placer hablar contigo! ¿Cómo estás hoy? ¿Tienes algo en particular que quieras hablar? Estoy aquí para ti. ¡Siempre estoy dispuesta a escuchar tus historias y a compartir algunos momentos agradables! ¡Espero que tengas un día maravilloso! 😊','TAMAGOTCHI'),
(219109934104576,'2025-04-24 16:57:33.672470',NULL,NULL,199268075270145,'cbvvbnm','ADULT'),
(219109940883456,'2025-04-24 16:57:35.325237',NULL,NULL,199268075270145,'Hola! Soy tu amigo virtual Tamagotchi. Estoy aquí para hablar contigo y disfrutar de una buena conversación. ¿Cómo estás hoy? ¿Tienes algo en particular que quieras hablar? Soy amable y conciso, así que estaré encantado de escuchar lo que tengas que decir. ¡Tengo mucha paciencia y estoy aquí','TAMAGOTCHI'),
(219126968983552,'2025-04-24 18:06:52.577043',NULL,NULL,199268075270145,'cvbn','ADULT'),
(219126975426560,'2025-04-24 18:06:54.149712',NULL,NULL,199268075270145,'Hola! Soy una mascota virtual llamada Tamagotchi. Estoy aquí para conversar con usted y disfrutar de nuestro tiempo juntos. Soy amable y conciso, y estoy encantado de hablar con usted. ¿Cómo estás hoy? ¿Tienes alguna pregunta o tema que quieras hablar? ¡Espero que tengas una gran','TAMAGOTCHI'),
(219128578617344,'2025-04-24 18:13:25.554697',NULL,NULL,199268075270145,'xcvb','ADULT'),
(219128584380416,'2025-04-24 18:13:26.960768',NULL,NULL,199268075270145,'Hola! Soy Tamagotchi, una mascota virtual encantada de hablar contigo. Estoy aquí para compartir un momento agradable y divertido. ¿Cómo estás hoy? ¿Tienes alguna historia que quieras compartir o preguntas que quieres hacer? Estoy aquí para ti. ¡Siempre estoy dispuesta a escuchar! 😊','TAMAGOTCHI');
...
--
-- Table structure for table `Emojies`
--

DROP TABLE IF EXISTS `Emojies`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8mb4 */;
...
--
-- Dumping data for table `Emojies`
--

LOCK TABLES `Emojies` WRITE;
/*!40000 ALTER TABLE `Emojies` DISABLE KEYS */;
INSERT INTO `Emojies` VALUES
...
(31,NULL,NULL,NULL,'shy/surprised','🤭',2,'Face with hand in mouth','U+1F92D'),
(32,NULL,NULL,NULL,'secretive','🤫',2,'Shushing face','U+1F92B'),
(33,NULL,NULL,NULL,'pensive/neutral','🤔',1,'Thinking face','U+1F914'),
(34,NULL,NULL,NULL,'no emotion','😐',1,'Neutral face','U+1F610'),
(35,NULL,NULL,NULL,'silent','🤐',1,'Zipped mouth','U+1F910'),
(36,NULL,NULL,NULL,'skeptical','🤨',2,'Face with raised eyebrow','U+1F928'),
(37,NULL,NULL,NULL,'blank','😑',1,'Expressionless face','U+1F611'),
(38,NULL,NULL,NULL,'speechless','😶',1,'Face with no mouth','U+1F636'),
(39,NULL,NULL,NULL,'sly/smug','😏',2,'Smirking face','U+1F60F'),
(40,NULL,NULL,NULL,'annoyed','😒',2,'Unamused face','U+1F612'),
(41,NULL,NULL,NULL,'dismissive','🙄',2,'Face with rolling eyes','U+1F644'),
(42,NULL,NULL,NULL,'discomfort','😬',3,'Grimacing face','U+1F62C'),
(43,NULL,NULL,NULL,'deceptive','🤥',3,'Lying face','U+1F925'),
(44,NULL,NULL,NULL,'tired','😪',2,'Sleepy face','U+1F62A'),
(45,NULL,NULL,NULL,'asleep','😴',1,'Sleeping face','U+1F634'),
(46,NULL,NULL,NULL,'calm/content','😌',3,'Relieved face','U+1F60C'),
(47,NULL,NULL,NULL,'reflective sadness','😔',2,'Pensive face','U+1F614'),
(48,NULL,NULL,NULL,'desire (e.g.','🤤',2,'Drooling face','U+1F924'),
(49,NULL,NULL,NULL,'sick/cautious','😷',2,'Face with mask','U+1F637'),
(50,NULL,NULL,NULL,'ill','🤒',3,'Face with thermometer','U+1F912'),
(51,NULL,NULL,NULL,'injured','🤕',3,'Face with bandage','U+1F915'),
(52,NULL,NULL,NULL,'sick/disgusted','🤢',4,'Nauseous face','U+1F922'),
(53,NULL,NULL,NULL,'extreme disgust','🤮',5,'Vomiting face','U+1F92E'),
(54,NULL,NULL,NULL,'allergies/cold','🤧',2,'Sneezing face','U+1F927'),
(55,NULL,NULL,NULL,'overheated','🥵',4,'Hot face','U+1F975'),
(56,NULL,NULL,NULL,'freezing','🥶',4,'Cold face','U+1F976'),
(57,NULL,NULL,NULL,'dizzy/confused','🥴',3,'Woozy face','U+1F974'),
(58,NULL,NULL,NULL,'dead/dizzy','😵',4,'Face with crossed-out eyes','U+1F635'),
(59,NULL,NULL,NULL,'mind-blown','🤯',5,'Face with exploding head','U+1F92F'),
(60,NULL,NULL,NULL,'puzzled','😕',3,'Confused face','U+1F615'),
(61,NULL,NULL,NULL,'anxious','😟',3,'Worried face','U+1F61F'),
(62,NULL,NULL,NULL,'mild sadness','🙁',2,'Slightly frowning face','U+1F641'),
(63,NULL,NULL,NULL,'sad','☹️',3,'Frowning face','U+2639'),
(64,NULL,NULL,NULL,'surprised','😮',3,'Face with open mouth','U+1F62E'),
(65,NULL,NULL,NULL,'shocked','😯',3,'Hushed face','U+1F62F'),
(66,NULL,NULL,NULL,'amazed','😲',4,'Astonished face','U+1F632'),
(67,NULL,NULL,NULL,'embarrassed','😳',4,'Flushed face','U+1F633'),
(68,NULL,NULL,NULL,'pleading','🥺',4,'Begging face','U+1F97A'),
(69,NULL,NULL,NULL,'distressed','😦',4,'Frowning face with open mouth','U+1F626'),
(70,NULL,NULL,NULL,'extreme distress','😧',5,'Anguished face','U+1F627'),
(71,NULL,NULL,NULL,'scared','😨',5,'Fearful face','U+1F628'),
(72,NULL,NULL,NULL,'nervous','😰',4,'Anxious face with sweat','U+1F630'),
(73,NULL,NULL,NULL,'tearful relief','😥',3,'Sad but relieved face','U+1F625'),
(74,NULL,NULL,NULL,'sad tears','😢',4,'Crying face','U+1F622'),
(75,NULL,NULL,NULL,'hysterical crying','😭',5,'Loudly crying face','U+1F62D'),
(76,NULL,NULL,NULL,'terror','😱',5,'Screaming face','U+1F631'),
(77,NULL,NULL,NULL,'frustrated','😖',4,'Confounded face','U+1F616'),
(78,NULL,NULL,NULL,'struggling','😣',4,'Persevering face','U+1F623'),
(79,NULL,NULL,NULL,'let down','😞',3,'Disappointed face','U+1F61E'),
(80,NULL,NULL,NULL,'stressed','😓',3,'Downcast face with sweat','U+1F613'),
(81,NULL,NULL,NULL,'exhausted','😩',4,'Weary face','U+1F629'),
(82,NULL,NULL,NULL,'fatigued','😫',3,'Tired face','U+1F62B'),
(83,NULL,NULL,NULL,'sleepy','🥱',2,'Yawning face','U+1F971'),
(84,NULL,NULL,NULL,'fuming','😤',4,'Face with steam','U+1F624'),
(85,NULL,NULL,NULL,'rage','😡',5,'Pouting face','U+1F621'),
(86,NULL,NULL,NULL,'angry','😠',4,'Angry face','U+1F620'),
(87,NULL,NULL,NULL,'cursing','🤬',5,'Face with symbols on mouth','U+1F92C'),
(88,NULL,NULL,NULL,'mischievous evil','😈',3,'Smiling face with horns','U+1F608'),
(89,NULL,NULL,NULL,'demonic rage','👿',5,'Angry face with horns','U+1F47F'),
(90,NULL,NULL,NULL,'death/dark humor','💀',3,'Skull','U+1F480'),
(91,NULL,NULL,NULL,'danger/death','☠️',4,'Skull and cross-bone','U+2620');
/*!40000 ALTER TABLE `Emojies` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `P2PMessage_seenBy` VALUES
(218812807794688,130);
...
INSERT INTO `P2PMessages` VALUES
(218812807794688,'2025-04-23 20:48:33.067249',NULL,NULL,'hallo wie geht es dir',199268075270145,130,NULL,'Sauer Zitrone');
...
CREATE TABLE `Prescription` (
  ...
  CONSTRAINT `FKovqj48ujgkpgb1kcutchfcaqr` FOREIGN KEY (`drug_id`) REFERENCES `Drugs` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_uca1400_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
(210938461782016,'2025-04-01 14:47:45.310501',NULL,'2025-04-24 18:50:28.007027',1,'\0','14:04:55.897000',-2328,-2428,58,-2382,2,-2402,97,'\0',50,'media\\image\\Avatar1_1.jpeg','test','🙂',1744637663962,0);
...
(130,'2023-06-21 14:40:55.880581',130,'2025-04-24 18:25:42.709127',NULL,'Sitrone@simone.de',0,'Sauer',NULL,'','','\0','','\0','\0','Zitrone','2025-04-24 18:25:42.706323','$2a$04$M2K6kiIkfsxqvHgl18/13OROOP3N3zqMgZgDHbTfktwz7LkDt/ZBe','+4915224625752','de','light',22,-1,'VERIFIED','CARER','Sitrone','ZRQJBAVOS3NUU3ERIGL2C37RBM74ZS7O',260,84233121845248,NULL,203885631447040);
...
-- Dump completed on 2025-04-24 18:50:47
