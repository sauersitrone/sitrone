 ...
 */
@JsModule("./misc/color-picker.ts")
@Tag("color-picker")
@Uses(ComboBox.class)
@Uses(CustomField.class)
public class TColorPicker
        extends AbstractSinglePropertyField<TColorPicker, String>
        implements HasSize, HasValidation, Focusable<TColorPicker>, HasHelper,
        HasLabel, HasTheme, HasStyle, HasThemeVariant<TColorPickerVariant>,
